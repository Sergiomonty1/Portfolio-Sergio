...
// ── Default menu data (from the current PDF cards) ──
...
export const menuService = {
  /**
   * Get menu data from Firestore. If none exists, seed with defaults.
   */
  ...
  /** Get default data for resetting */
